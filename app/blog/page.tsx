...
const WA_MSG = "Hola, me interesa AgendyFix para mi academia. Quiero agendar una demo.";

export const metadata: Metadata = {
  title: "Blog — Software para Academias y Escuelas",
  description:
          ...
          {posts.length > 0 && (
            <div className="rounded-2xl bg-gradient-to-br from-secondary via-secondary/80 to-accent border border-accent/40 p-6 md:p-8 text-center mt-8">
              ...
              <p className="text-white/85 mb-5 max-w-md mx-auto text-sm leading-relaxed">
                Agenda una demo y te mostramos cómo AgendyFix transforma la
                operación de tu academia en menos de una semana.
              </p>
              <a
                href={buildWaUrl(WA_MSG)}
                target="_blank"
