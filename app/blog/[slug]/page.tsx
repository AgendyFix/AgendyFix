...
const WA_MSG = "Hola, quiero agendar una demo de AgendyFix para mi academia.";
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: post.coverImage || `${siteUrl}/logo.png`,
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: `${post.title} | AgendyFix`,
      description: post.description,
      images: [post.coverImage || `${siteUrl}/logo.png`],
    },
  };
}
...
export default async function BlogArticlePage({
  ...
  const postKeywords = new Set(post.keywords.map((k: string) => k.toLowerCase()));
  ...
  const articleJsonLd: Record<string, unknown> = {
    ...
    headline: post.title,
    description: post.description,
    image: post.coverImage ? `${siteUrl}${post.coverImage}` : `${siteUrl}/logo.png`,
